...
class MinimalEnv(gym.Env):
    ...
    def reset(self, seed=None, options=None):
        ...
        # This returns: input_mode_flux, mode_transmission_1, mode_transmission_2, hzfield_state, hz_data, input_mode, mode_transmission_1, mode_transmission_2
    ...
    def step(self, action):
        ...
        if self.is_surrogate and not self.is_eval:
            ...
            # surrogate_model.predict returns a dict; extract numeric values safely
